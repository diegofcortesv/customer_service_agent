...
class PriorityAssessmentTool:
    """Tool for assessing case priority and routing decisions"""
    
    def calculate_priority(self, customer_tier: str, issue_type: str, sentiment: str, urgency: str, escalation_risk: str) -> Dict[str, Any]:
        """Calculate case priority based on multiple factors"""
        
        priority_score = 0
        factors = []
        
        # Factor: Customer Tier (peso alto)
